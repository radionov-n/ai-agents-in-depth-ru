...
Подробная атрибуция приведена также в файле [`NOTICE`](NOTICE).

## Лицензия

Материалы этого репозитория распространяются на условиях [Apache License 2.0](LICENSE), с сохранением атрибуции оригинальному автору и указанием внесённых изменений. Репозиторий `mldogs/skill-factory` лицензирован отдельно по MIT License.
